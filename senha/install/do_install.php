    ...
    try {
        ...
        try {
            ...
            if ($db['db_type'] == 'pgsql') {
                ...
                if (!$result) {
                    throw new Exception(pg_last_error($dbcon)."axl");
                }
                pg_close($dbcon);
            ...
            if (strpos($config_content, 'const AXL_INSTALLED = false;') === FALSE) {
            ...
            $config_content = str_replace('const AXL_INSTALLED = false;', 'const AXL_INSTALLED = true;', $config_content);
            ...
            Template::display_confirm_dialog('O ' . AXL::NAME . ' foi instalado com sucesso!', 'INSTALAÇÃO', 'document.location.reload();');
        } catch (Exception $e) {
