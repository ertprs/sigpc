...
class TConfiguracao extends Template {
	...
	public static function display_header($title='') {
		...
		$misc .= '<script type="text/javascript">
			                ...
			                AXL.addOnLoadListener(conf.refresh);
		          </script>';
    ...
    public static function display_config_atendimento() {
        ...
        Template::display_menu_button('Reiniciar<br />Senhas', 'themes/axl.default/imgs/edit-clear-history.png', 'Configuracao.reiniciarSenhas();', "Armazena todas as senhas de todas unidades no histórico.");
    }
	...
	public function display_group_control_image($id_grupo) {
		?>
			<img src="?redir=modules/axl/configuracao/grupos/img_grupo.php?id_grupo=<?php echo $id_grupo;?>" />
		<?php
	}
	...
	public static function displayer_unidades_search() {
		...
		?>
			...
			<div>
				<input title="Digite o termo de busca." type="text" id="search_input" maxlength="50" name="search_input" onkeypress="return AXL.txtBoxAlfaNumerico(this,event,'id_buscar_uni','id_buscar_uni');"/>
	...
	public static function display_nova_unidade() {
	    ...
	    ?>
		   <form id="nova_uni" onsubmit="Configuracao.salvarUnidade(false,'<?php echo $array_uni;?>'); return false;">
	            <div id="cod_criar_uni" title='Código da unidade'><span>Código:</span><input type="text" id="cod_uni_novo" name="cod_uni_novo" maxlength="10"  onkeypress="return AXL.txtBoxAlfaNumerico(this,event);"  /><label class="advertencia" id="id_label_criar_cod"></label></div>
		...
		<div id="edit_uni_info">
			<div id="editar_unidade">
	            ...
	            <div title='Código da unidade'>
		            <span>Código:</span>
		            <span>
		            	<input type="text" id="cod_uni" name="cod_uni" <?php echo $disable;?> value="<?php echo $unidade->get_codigo();?>" maxlength="10" onkeypress="return AXL.txtBoxAlfaNumerico(this,event);" />
