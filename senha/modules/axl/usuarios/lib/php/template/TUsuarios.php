...
class TUsuarios extends Template {
	...
	public static function display_header($title='') {
		...
		$misc .= '<script type="text/javascript">
			                ...
			                AXL.addOnLoadListener(usuarios.refresh);
		          </script>';
		parent::display_header($title, $misc);
	}

	/**
	 * Mostra o topo menu e conteudo padrões do AXL 
	 */
 ...
 *
	...
	public static function display_users_config() {
		...
		?>
			<div id="config_users">
		        ...
		        $lotacoes = DB::getInstance()->get_lotacoes_editaveis($admin->get_id(), Session::getInstance()->get(AXL::K_CURRENT_MODULE)->get_id(), $raiz->get_id(), true);
	...
	public static function displayer_user_search() {
		...
		?>
			...
			<div>
				<input title="Digite o termo da busca." maxlength="120" type="text" id="search_input" name="user_input" onkeypress="return AXL.txtBoxAlfaNumerico(this, event, 'id_buscar_usuario');"/>
    ...
    public static function display_edit_user(Usuario $usuario = null, $id_grupo = null) {
        ...
        //$auto_disable = (Session::getInstance()->get(AXL::K_CURRENT_USER)->get_id() == $usuario->get_id())? 'disabled="disabled"' : '';
        ?>
        <form>
            ...
            <div title="Nome do usuário, máximo 10 dígitos.">
                <span>Usuário</span>
                <input  type="text" id="login_usu" name="login_usu" <?php echo $disable;?> value="<?php echo $login_usu;?>" maxlength="10"  onkeypress="return AXL.txtBoxAlfaNumerico(this,event);" size="27" />
            ...
            <div title="Serviços que o usuário pode atender.">
                ...
                <ul class="config_user_control">
                    ...
                    <?php
                    if ($editando) {
                        if($usuario->get_id() == Session::getInstance()->get(AXL::K_CURRENT_USER)->get_id()){
