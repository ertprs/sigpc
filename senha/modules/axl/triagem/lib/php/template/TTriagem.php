...
class TTriagem extends Template {
	...
	public static function display_header($title='') {
		AXL::_include("modules/axl/triagem/content_loader.php");
		...
		$misc .= '<script type="text/javascript">
			            ...
			            AXL.addOnLoadListener(triagem.refresh);
				</script>';
		...
		<body onLoad="window.print();window.close();" >
			<div align="center" id="imprime">
				...
				<div align="center" id="imp_senha">
					...
					<div id="imp_data"><?php echo AXL::get_date("d/m/Y H:i"). $senha->get_prioridade();?></div>
				</div>
	...
	public static function exibir_cancelar_senha_por_senha() {
		...
		<form onsubmit="Triagem.procuraSenha(); return false;">
			<label for="id_text_senha">Digite a senha: </label> <input title="Digite o termo da busca" style="width: 105px" type="text" maxlength="10" id="id_text_senha" onkeypress="return AXL.txtBoxSoNumeros(this,event)" onclick="Triagem.selecionaTextBox(this)" /> 
