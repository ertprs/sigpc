...
class TAdmin extends Template {
	...
	public static function display_header($title='') {
		...
		$misc .= '<script type="text/javascript">
                        var adm = new Admin();
                        AXL.addOnLoadListener(adm.refresh);
		          </script>';
    ...
    public static function display_config_atendimento() {
        ...
        Template::display_menu_button('Reiniciar<br />Senhas', 'themes/axl.default/imgs/edit-clear-history.png', 'Admin.reiniciarSenhas();', 'Armazena todas as senhas da unidade no histórico.');
    }
