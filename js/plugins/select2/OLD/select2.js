...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        unselect: function (selected) {
            ...
            if (selected.length === 0) {
                throw "Argument invalido: " + selected + ". Deve ser .select2-search-choice";
            }
        ...
        val: function () {
            ...
            if (this.select) {
                ...
                if (this.opts.initSelection === undefined) {
                    throw new Error("val() não pode ser chamado se initSelection() não é definida");
                }
        ...
        onSortStart: function() {
            if (this.select) {
                throw new Error("Classificação de elementos não é suportado quando ligado a <select>. anexar a <input type='hidden'/> ao invés.");
            }
        ...
        this.each(function () {
            if (args.length === 0 || typeof(args[0]) === "object") {
                ...
                if (indexOf(args[0], allowedMethods) < 0) {
                    throw "Método desconhecido: " + args[0];
                }
                ...
                throw "Argumentos invalidos do plugin: " + args;
            }
        });
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Por favor insira " + n + " caractere" + (n == 1? "" : "s"); },
